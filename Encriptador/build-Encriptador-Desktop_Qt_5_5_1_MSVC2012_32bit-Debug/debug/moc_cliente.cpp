...
#include "../../../../../Desktop/Encriptador/Encriptador/cliente.h"
...
void Cliente::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->estado((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Cliente::estado)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Cliente::estado(QString _t1)
{
