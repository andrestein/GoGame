...
#include "../../Encriptador/servidor.h"
...
QT_MOC_LITERAL(1, 9, 13), // "sesionAbierta"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 6), // "estado"
QT_MOC_LITERAL(4, 31, 6), // "enviar"
QT_MOC_LITERAL(5, 38, 7) // "mensaje"

    },
    "Servidor\0sesionAbierta\0\0estado\0enviar\0"
    "mensaje"
};
...
void Servidor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sesionAbierta(); break;
        case 1: _t->estado((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->enviar((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Servidor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Servidor::sesionAbierta)) {
                *result = 0;
            }
        }
        {
            typedef void (Servidor::*_t)(const QString );
...
// SIGNAL 0
void Servidor::sesionAbierta()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void Servidor::estado(const QString _t1)
{
