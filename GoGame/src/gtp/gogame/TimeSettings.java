...
public final class TimeSettings
{
    ...
    public static TimeSettings parse(String s) throws Error
    {
        ...
        else
        {
            ...
            {
                throw new Error("Invalid specification for byoyomi"
                                       + " moves");
            }
        }
        if (preByoyomi <= 0)
        ...
        if (useByoyomi)
        {
            ...
            if (byoyomiMoves <= 0)
                throw new Error("Byoyomi moves must be positive");
    ...
    private static long parseTime(String s) throws Error
    {
        ...
        {
            throw new Error("Invalid time specification: '" + s + "'");
        }
    }
